...
class CryptographyManagerImpl:CryptographyManager {
    ...
    private val ENCRYPTION_BLOCK_MODE: String = KeyProperties.BLOCK_MODE_GCM
    private val ENCRYPTION_PADDING = KeyProperties.ENCRYPTION_PADDING_NONE
    private val ENCRYPTION_ALGORITHM = KeyProperties.KEY_ALGORITHM_AES

    override fun getInitializedCipherForEncryption(keyName: String): Cipher {
        val cipher = getCipher()
        val secretKey = getOrCreateSecreatKey(keyName)
    ...
    private fun getOrCreateSecreatKey(keyName: String):SecretKey{
